...
export default class Buttons extends React.Component {
    ...
    render() {
        return (<div id="buttons">
            ...
            <button className="button" id="divide" onClick={this.props.math}>/</button>
            <button className="button" id="multiply" onClick={this.props.math}>*</button>
            ...
            <button className="button" id="subtract" onClick={this.props.math}>-</button>
            ...
            <button className="button" id="add" onClick={this.props.math}>+</button>
            ...
            <button className="button" id="equal" onClick={this.props.math}>=</button>
            <button className="button" id="zero" onClick={this.props.numbers} value='0'>0</button>
            <button className="button" id="decimal" onClick={this.props.math}>.</button>
        </div>)
    }
}
